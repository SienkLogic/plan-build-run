...
After all tasks complete (or at a checkpoint), create/update `.planning/phases/{phase_dir}/SUMMARY.md`:
...
| `partial` | Some tasks completed, execution stopped (deviation, error, context limit) |
