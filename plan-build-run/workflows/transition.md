...
Exit skill and invoke SlashCommand("/pbr:discuss-phase [X+1]")
...
Exit skill and invoke SlashCommand("/pbr:plan-phase [X+1]")
...
**Also available:**
- `/pbr:discuss-phase [X+1]` — update existing context
- `/pbr:research-phase [X+1]` — investigate unknowns
- Review roadmap
