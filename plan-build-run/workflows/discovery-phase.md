...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /pbr:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/plan-build-run/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/plan-build-run/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/plan-build-run/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/plan-build-run/templates/discovery.md
...
Use ~/.claude/plan-build-run/templates/discovery.md.
...
1. Discuss phase context (/pbr:discuss-phase [current-phase])
2. Create phase plan (/pbr:plan-phase [current-phase])
