...
/**
 * lib/context.cjs -- Context triage for orchestrator decision-making.
 *
 ...
 *   1. .context-budget.json   -- written by context-bridge, contains real % from Claude
 *   2. .context-tracker       -- written by track-context-budget, heuristic char count
 *
 * Decision thresholds:
