...
/**
 * learnings.cjs -- Global cross-project learnings store for Plan-Build-Run.
 *
 ...
 *
 * Usage (library):
 *   const { learningsIngest, learningsQuery } = require('./learnings.cjs');
 *
...
function checkDeferralThresholds(options = {}) {
  ...
  // Query count: default 0 (separate counter not implemented in v1)
  const queryCount = 0;
