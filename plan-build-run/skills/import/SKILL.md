...
- Run: `node ${CLAUDE_PLUGIN_ROOT}/scripts/pbr-tools.cjs state load`
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/pbr-tools.cjs event workflow plan-import --phase {N} --plans {count} --source {filepath_or_user_input}
```
