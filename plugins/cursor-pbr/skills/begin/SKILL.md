...
| Topic | Template Path |
|-------|--------------|
| STACK | `${PLUGIN_ROOT}/templates/research-outputs/STACK.md.tmpl` |
| FEATURES | `${PLUGIN_ROOT}/templates/research-outputs/FEATURES.md.tmpl` |
| ARCHITECTURE | `${PLUGIN_ROOT}/templates/research-outputs/ARCHITECTURE.md.tmpl` |
| PITFALLS | `${PLUGIN_ROOT}/templates/research-outputs/PITFALLS.md.tmpl` |

Include the resolved absolute path in the researcher prompt (resolve `${PLUGIN_ROOT}` before sending).
