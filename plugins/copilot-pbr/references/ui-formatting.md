...
> **Migration note:** Skills are being migrated to these patterns. See Phase 5 for skill-level updates.
...
|--------|-----------|-------|
| Complete | `✓` | Completed items, passed checks, verified |
| Failed | `✗` | Failed verification, missing items, blocked |
| In Progress | `◆` | Currently executing |
| Pending | `○` | Not yet started |
| Auto-approved | `⚡` | Automatically approved (gates) |
| Warning | `⚠` | Warnings, non-blocking issues |
| Milestone | `🎉` | Milestone complete (banner only) |
...
For questioning philosophy, when to use/not use AskUserQuestion, freeform rule, and decision gate patterns, see `references/questioning.md`.
