 ...
 *   towline-executor   → SUMMARY-{plan_id}.md (or SUMMARY.md) in the phase directory
 *   towline-planner    → PLAN-{MM}.md in the phase directory
 *   towline-verifier   → VERIFICATION.md in the phase directory
 *   towline-researcher → RESEARCH.md (or domain-specific .md) in research/
 *
 * Exit codes:
...
function main() {
  ...
  // Only relevant for Towline projects
  ...
  // Only check known Towline agent types
