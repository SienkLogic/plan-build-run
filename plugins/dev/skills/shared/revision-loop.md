...
|-------|---------------|---------------|-------------------|
| plan | towline-planner | towline-plan-checker | `skills/plan/templates/revision-prompt.md.tmpl` |
| import | inline (orchestrator) | towline-plan-checker | Inline revision by orchestrator |
| review (auto-fix) | towline-planner (gap mode) | towline-plan-checker | Same as plan |
