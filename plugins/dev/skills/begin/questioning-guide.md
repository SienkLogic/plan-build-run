...
Techniques for understanding a user's project vision during `/dev:begin`. The goal is to build a complete mental model of what needs to be built, not just a feature list.
