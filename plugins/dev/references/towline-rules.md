...
67. Skills: `plugins/dev/skills/{skill-name}/SKILL.md` — lowercase hyphenated dir, uppercase `SKILL.md`.
68. Agents: `plugins/dev/agents/towline-{name}.md` — must start with `towline-` prefix.
69. Scripts: `plugins/dev/scripts/{name}.js` — lowercase, hyphenated, CommonJS.
70. References: `plugins/dev/references/{name}.md` — lowercase, hyphenated.
