...
After building a phase, Towline runs automated verification to check whether the code actually delivers what was planned. It checks every "must-have" from the plan through three layers:
...
- **Attempt 3+**: Escalation — Towline will offer additional options like accepting with gaps, switching to debug mode, or re-planning the phase
