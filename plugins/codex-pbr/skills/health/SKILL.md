...
- `.planning/PROJECT.md`
  If missing: `⚠ PROJECT.md not found. Run $pbr-begin to generate it, or create from ${PLUGIN_ROOT}/templates/PROJECT.md.tmpl.`

- `.planning/REQUIREMENTS.md`
  If missing: `⚠ REQUIREMENTS.md not found. Run $pbr-begin to generate it, or create from ${PLUGIN_ROOT}/templates/REQUIREMENTS.md.tmpl.`
