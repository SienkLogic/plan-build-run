...
- `.planning/PROJECT.md`
  ...
  If present: Check for `## Context` section (merged from legacy CONTEXT.md). If missing: `⚠ PROJECT.md has no ## Context section. Run $pbr-begin to regenerate, or add manually.`
...
- If `.planning/CONTEXT.md` exists alongside `PROJECT.md` with `## Context` section: `⚠ Legacy CONTEXT.md detected alongside merged PROJECT.md. Run $pbr-begin to migrate — the legacy file can be removed.`
- If `.planning/HISTORY.md` exists alongside `STATE.md` with `## History` section: `⚠ Legacy HISTORY.md detected alongside merged STATE.md. Run $pbr-begin to migrate — the legacy file can be removed.`
