...
| A complex task: refactoring, migration, multi-file architecture, system redesign | `$pbr-plan-phase add` | Needs a full phase with research/plan/build cycle |
| A review or quality concern about existing work | `$pbr-verify-work` | Needs verification against plan |
...
- $pbr-plan-phase add — Full planning cycle (recommended for multi-file refactors)
