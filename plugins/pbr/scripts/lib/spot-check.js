...
/**
 * lib/spot-check.js -- Machine-enforced output spot checks for PBR agents.
 *
...
function checkPlan(dirPath) {
  ...
  // Check 1: At least one PLAN*.md file exists
...
module.exports = { verifySpotCheck, cmdPlanValidate };
