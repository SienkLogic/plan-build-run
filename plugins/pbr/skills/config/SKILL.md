...
First, check for global defaults: `pbr-tools config load-defaults`
...
If yes, run: `pbr-tools config save-defaults`
...
To resolve the profile, run: `pbr-tools config resolve-depth`
...
```bash
pbr-tools" config save-defaults
```
