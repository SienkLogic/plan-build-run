...
> Calibration data (optional): .planning/intel/plan-checker-calibration.md — gap pattern distribution from corpus analysis
> Reasoning models: `references/thinking-models-verification.md` — structured reasoning for plan quality evaluation (planning fallacy calibration, counterfactual thinking)
