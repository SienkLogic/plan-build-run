...
`
    ...
    const result = runPbrTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runPbrTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md --fields one_liner,key_files,requirements_completed', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('progress command', () => {
  ...
  test('renders JSON progress', async () => {
    ...
    const result = runPbrTools('progress json', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders bar format', async () => {
    ...
    const result = runPbrTools('progress bar --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders table format', async () => {
    ...
    const result = runPbrTools('progress table --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('does not crash when summaries exceed plans (orphaned SUMMARY.md)', async () => {
    ...
    const barResult = runPbrTools('progress bar --raw', tmpDir);
...
describe('todo complete command', () => {
  ...
  test('moves todo from pending to completed', async () => {
    ...
    const result = runPbrTools('todo complete add-dark-mode.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('list-todos command', () => {
  ...
  test('area filter returns only matching todos', async () => {
    ...
    const result = runPbrTools('list-todos ui', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter miss returns zero count', async () => {
    ...
    const result = runPbrTools('list-todos nonexistent-area', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('verify-path-exists command', () => {
  ...
  test('absolute path resolves correctly', async () => {
    ...
    const result = runPbrTools(`verify-path-exists ${absFile}`, tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('commit command', () => {
  ...
  test('creates real commit with correct hash', async () => {
    ...
    const result = runPbrTools('commit "test: add test file" --files .planning/test-file.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('amend mode works without crashing', async () => {
    ...
    const result = runPbrTools('commit "ignored" --files .planning/amend-file.md --amend', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
