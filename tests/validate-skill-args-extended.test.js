...
describe('PLAN_VALID_PATTERN', () => {
  ...
  test('matches phase number with flags', () => {
  ...
  test('does not match freeform text', () => {
...
describe('suggestSkill', () => {
  test('suggests /pbr:debug for bug-related text', () => {
  ...
  test('suggests /pbr:explore for research-related text', () => {
  ...
  test('suggests /pbr:plan-phase add for complex tasks', () => {
  ...
  test('suggests /pbr:quick for simple actionable text', () => {
...
describe('validatePhaseExists', () => {
  ...
  test('returns null when phase exists in roadmap', () => {
  ...
  test('returns warning when phase not found', () => {
    const roadmap = '| 01 | Foundation | 01-01 | Planned |\n| 02 | Auth | 02-01 | Planned |';
    fs.writeFileSync(path.join(tmpDir, '.planning', 'ROADMAP.md'), roadmap);
...
describe('checkSkillArgs', () => {
  ...
  test('blocks freeform text for plan skill', () => {
  ...
  test('includes skill suggestion in block reason', () => {
  ...
  test('truncates long args in block reason', () => {
  ...
  test('blocks invalid phase number for phase skills', () => {
    const roadmap = '| 01 | Foundation | 01-01 | Planned |';
    fs.writeFileSync(path.join(tmpDir, '.planning', 'ROADMAP.md'), roadmap);
  ...
  test('passes valid phase number for phase skills', () => {
    const roadmap = '| 01 | Foundation | 01-01 | Planned |';
    fs.writeFileSync(path.join(tmpDir, '.planning', 'ROADMAP.md'), roadmap);
  ...
  test('handles skill name without pbr: prefix', () => {
    const roadmap = '| 01 | Foundation | 01-01 | Planned |';
    fs.writeFileSync(path.join(tmpDir, '.planning', 'ROADMAP.md'), roadmap);
  ...
  test('all PHASE_SKILLS are recognized', () => {
...
describe('ROUTE_PATTERNS', () => {
  test('has at least 4 patterns', () => {
    expect(ROUTE_PATTERNS.length).toBeGreaterThanOrEqual(4);
  });

  test('last pattern is catch-all', () => {
