...
export default function App() {
  ...
  // Reset selectedPhase when nav changes — intentional state sync on nav transition
  useEffect(() => {
    setSelectedPhase(null); // eslint-disable-line react-hooks/set-state-in-effect
  }, [nav]);
  ...
  const pageTitle = (nav === 'roadmap' && selectedPhase)
    ? `Phase: ${selectedPhase.name}`
    : (currentNavItem ? currentNavItem.label : 'Overview');
